...
class Chair:
    # accessiable properties
    chair_color = "brown"

    def __init__(self, height, width, length):
        self.chair_height = height
        self.__width = width          #__ makes property 'width' to be very private # to print it {userchair1._Chair__width}
    ...
    #method to pass the volume of the chair
...
print (f"The price of the chair is $ {userchair1.setprice(25)}") # it will show none because it set to private
#to call private method we should set the price 
